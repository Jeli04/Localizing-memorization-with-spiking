...
\begin{enumerate}
    \item The step size is chosen on the validation set. It is the step that best minimizes the accuracy difference between members and non-members.

    \item Fisher diagonals are calculated on gradients from non-members and members. K-FAC are trained on data from non-members. 
\end{enumerate}
