...
\begin{table}[h]
    ...
    \begin{tabular}{@{}c c c c c@{}}
        ...
        & \textbf{Loss}
        & \textbf{Min-K\%}
        & \shortstack{\textbf{Projection}\\\textit{(no reference)}}
        & \cellcolor{gray!18}
